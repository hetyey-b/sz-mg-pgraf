...
protected:
	...
	// Feny tulajdonsagok
	glm::vec3 m_lightDir = glm::vec3(0.0f, 0.0f, -1.0f);
    ...
    float m_lightBattery = 100.0f;
    bool swapping_battery = false;
    float battery_swap_progress = 0.0f;
    ...
    GLuint  m_loc_light_switch = 0;
    GLuint m_loc_light_battery = 0;
